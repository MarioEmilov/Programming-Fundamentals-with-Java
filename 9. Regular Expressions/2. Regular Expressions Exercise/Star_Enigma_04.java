...
public class Star_Enigma_04 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            String decryptedMessage = getDecryptedMessage(encryptedMessage, countSpecialLetter);
    ...
    private static String getDecryptedMessage(String encryptedMessage, int reducedValue) {
