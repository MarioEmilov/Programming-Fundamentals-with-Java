    ...
    public static void main(String[] args) {
        ...
        while (!userInput.equals("end")) {
            ...
            if (userIsCheating(firstIndex, secondIndex, sequence)) {
                ...
                //add 2 new cards in te middle of the sequence
            ...
            if (firstNumber.equals(secondNumber)) {
                //казваме директно да се махнат повтарящия се string
                ...
                /* проверяваме индексите но понеже са стрингове директно като обекти може да ги махнем
